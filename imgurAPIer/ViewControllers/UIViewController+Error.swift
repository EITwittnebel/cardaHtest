...
extension UIViewController {
  ...
  func presentErrorAlert(error: ImgurErrors) {
    switch error {
    case .other:
    ...
    case .badData:
      self.presentErrorAlert(title: "Bad Image Data", message: "Bad image data.")
    default:
      self.presentErrorAlert(title: "Rate Limited", message: "You have been rate limited, please try again later")
    }
  }
}
